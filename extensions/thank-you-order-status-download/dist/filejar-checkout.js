(() => {
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/Tag/Tag.mjs
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/Tag/Tag.mjs
  ...
  // extensions/thank-you-order-status-download/src/ThankYouBlock.jsx
  var import_react17 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var thankYouBlock = reactExtension("purchase.thank-you.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DownloadDetails, {}));
  var DownloadDetails = () => {
    const [downloadUrl, setDownloadUrl] = (0, import_react17.useState)("#");
    ...
    (0, import_react17.useEffect)(() => {
      const runEffect = () => __async(void 0, null, function* () {
        if ((order == null ? void 0 : order.id) && token && (shop == null ? void 0 : shop.myshopifyDomain)) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      View2,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
          (editor == null ? void 0 : editor.type) === "checkout" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Tag2, { icon: "info", children: "PREVIEW" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: headline }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: body }),
  ...
  var ExtensionApiContext2 = /* @__PURE__ */ (0, import_react18.createContext)(null);
  ...
  var ErrorBoundary2 = class extends import_react19.Component {
    constructor(...args) {
      super(...args);
      this.state = {
        hasError: false
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/hooks/api.mjs
  function useApi2() {
    const api = (0, import_react22.useContext)(ExtensionApiContext2);
    if (api == null) {
  ...
  function useSubscription2(subscription) {
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/hooks/shop.mjs
  function useShop() {
    const api = useApi2();
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/hooks/extension-editor.mjs
  function useExtensionEditor2() {
    return useApi2().extension.editor;
  }
  ...
  function useOrder() {
    const api = useApi2();
    if ("order" in api) {
      return useSubscription2(api.order);
    }
    throw new ExtensionHasNoMethodError("order", api.extension.target);
  }

  // extensions/thank-you-order-status-download/src/OrderStatusBlock.jsx
  var import_react24 = __toESM(require_react());
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var orderDetailsBlock = reactExtension2("customer-account.order-status.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DownloadDetails2, {}));
  var DownloadDetails2 = () => {
    const [downloadUrl, setDownloadUrl] = (0, import_react24.useState)("#");
    ...
    const shop = useShop();
    const { checkoutToken } = useApi2();
    const token = useSubscription2(checkoutToken);
    (0, import_react24.useEffect)(() => {
      const runEffect = () => __async(void 0, null, function* () {
        if ((order == null ? void 0 : order.id) && (shop == null ? void 0 : shop.myshopifyDomain)) {
          const order_id = order.id.replace(/gid:\/\/shopify\/(Order|OrderIdentity)\//, "");
          const isEditor = (editor == null ? void 0 : editor.type) === "checkout";
          const res = yield fetch(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Card2, { padding: true, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(BlockStack2, { children: [
      (editor == null ? void 0 : editor.type) === "checkout" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Tag2, { icon: "info", children: "PREVIEW" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { children: headline }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { children: body }),
...
//# sourceMappingURL=filejar-checkout.js.map
